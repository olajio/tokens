...
def _build_summary_sheet(ws, rows: list[dict], clusters: list[str], logstash_dirs: list[str]):
...
def build_workbook(rows: list[dict], output_path: str, cluster_names: list[str], logstash_dirs: list[str]):
    wb = Workbook()
